% options_pub.outputDir=fullfile(pwd,'latex','126','html'); options_pub.showCode=true;
% publish(fullfile(pwd,'cal_report_126a2.m'),options_pub);
...
temperature{Cal.n_inst}.t_range=[min(Fr(:,2)),max(Fr(:,2))];
temperature{Cal.n_inst}.Fnew=Fnew;
temperature{Cal.n_inst}.Forig=Forig;
