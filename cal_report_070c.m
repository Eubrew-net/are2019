...
% close all; publish(fullfile(pwd,'cal_report_070c.m'),options_pub);
...
legend(gca,'inst','IZO#070','Location','NorthEast'); grid;
datetick('x',26,'KeepLimits','KeepTicks');
ozone_filter_analysis_mi(summary,Cal);
%% Ozone Calibration
% Reference Brewer #070
close all
...
% Esto podr?a ser una incoherencia: por ejemplo para el 072 sale 3179, pero mantenemos 3070.
