...
% publish(fullfile(pwd,'cal_report_172a2.m'),options_pub);
...
[NTC{2},ajuste{2},Args{2},Fraw,Fnew]=temp_coeff_raw(config_temp,sl_raw{Cal.n_inst},'outlier_flag',1,'intensity_flag',1,...
