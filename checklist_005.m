...
dt_std=sprintf('low=%.1f +/- %.2f %chigh=%.1f +/- %.2f',m(end,4),s(end,4),char(10),m(end,5),s(end,5))            
...
sl_temp=sprintf('R6 =%.1f [%.2f,%.2f] %c  %.1f  [%.2f,%.2f]',b(1),bi(1,1),bi(1,2),char(10),b(2),bi(2,1),bi(2,2))            
mat2sheets_jls('1WBzxK6bPrkD6mKIzkG8BbhlQgx0zLpsvvSmhllwDCiw',sprintf('Brewer#%03d',Cal.brw(Cal.n_inst)),...
                [16 5],round(b(2),2));
mat2sheets_jls('1WBzxK6bPrkD6mKIzkG8BbhlQgx0zLpsvvSmhllwDCiw',sprintf('Brewer#%03d',Cal.brw(Cal.n_inst)),...
                [16 6],{sl_temp});
...
mat2sheets_jls('1WBzxK6bPrkD6mKIzkG8BbhlQgx0zLpsvvSmhllwDCiw',sprintf('Brewer#%03d',Cal.brw(Cal.n_inst)),...
                [17 5],avg.RcincoAVG);
%mat2sheets_jls('1WBzxK6bPrkD6mKIzkG8BbhlQgx0zLpsvvSmhllwDCiw',sprintf('Brewer#%03d',Cal.brw(Cal.n_inst)),...
%                [17 9],Cal.SL_OLD_REF(Cal.n_inst));
            
% R5 temp 18
% 
[b,bi]=regress(avg.sl_data(:,11),[ones(size(avg.sl_data(:,5))),avg.sl_data(:,5)]);            
sl_temp=sprintf('R5 =%.1f [%.2f,%.2f] %c  %.1f  [%.2f,%.2f]',b(1),bi(1,1),bi(1,2),char(10),b(2),bi(2,1),bi(2,2))            
mat2sheets_jls('1WBzxK6bPrkD6mKIzkG8BbhlQgx0zLpsvvSmhllwDCiw',sprintf('Brewer#%03d',Cal.brw(Cal.n_inst)),...
                [18 5],round(b(2),2));
mat2sheets_jls('1WBzxK6bPrkD6mKIzkG8BbhlQgx0zLpsvvSmhllwDCiw',sprintf('Brewer#%03d',Cal.brw(Cal.n_inst)),...
                [18 6],{sl_temp});
