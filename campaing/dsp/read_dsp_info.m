function [dsp_quad dsp_cubic salida]=read_dsp(dsp_dir,varargin)
...
% --------------------------------------------------------------------------------------
function [wv_matrix_quad wv_matrix_cubic SALIDA r DETAIL]=no_hay_mat(path_dsp,ldsp,indx,inst_info,brw_config_files) 
