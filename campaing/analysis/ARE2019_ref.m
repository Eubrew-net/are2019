...
%% Oveview of campaign
close all
figure; p(1)=plot(summary{2}(diaj(summary{2}(:,1))>day0,1),summary{2}(diaj(summary{2}(:,1))>day0,6),Cal.plt{2},'MarkerSize',5); hold all
        p(2)=plot(summary{10}(diaj(summary{10}(:,1))>day0,1),summary{10}(diaj(summary{10}(:,1))>day0,6),Cal.plt{10},'MarkerSize',5); 
        p(3)=plot(summary{11}(diaj(summary{11}(:,1))>day0,1),summary{11}(diaj(summary{11}(:,1))>day0,6),Cal.plt{11},'MarkerSize',5); 
        p(4)=plot(summary{14}(diaj(summary{14}(:,1))>day0,1),summary{14}(diaj(summary{14}(:,1))>day0,6),Cal.plt{14},'MarkerSize',5); 
        p(5)=plot(summary{15}(diaj(summary{15}(:,1))>day0,1),summary{15}(diaj(summary{15}(:,1))>day0,6),Cal.plt{15},'MarkerSize',5); 
        p(6)=plot(summary{17}(diaj(summary{17}(:,1))>day0,1),summary{17}(diaj(summary{17}(:,1))>day0,6),Cal.plt{17},'MarkerSize',5);
%set(gca,'YLim',[280 350],'XLim',datenum(Cal.Date.cal_year,1,[day0 dayend-5])); 
legend(Cal.brw_name([2,10,11,14,15,17]))
title(Cal.campaign,'FontSize',12); ylabel('Total Ozone Content [DU]','FontSize',12); 
datetick('x',6,'KeepLimits','KeepTicks');
grid on; legendflex(p,Cal.brw_name([2,10,11,14,15,17]),'anchor',{'se','se'},'buffer',[-5 5],...
