...
% publish(fullfile(pwd,'cal_report_017a2.m'),options_pub);
...
[NTC{2},ajuste{2},Args{2},Fraw,Fnew]=temp_coeff_raw(config_temp,sl_raw{Cal.n_inst},'intensity_flag',1,'outlier_flag',1,...
                       'date_range',datenum(Cal.Date.cal_year-4,7,15));   % two years before calibration
