...
%\textsl{\textbf{EQUIPO QUE CAMBIA O QUE SE HA ENCONTRADA UNOS COEFICIENTES TAN BUENOS COMO LOS QUE TENÍA}}
...
\begin{figure}[htbp!]
\begin{center}   
     \includegraphics[width=12cm]{./xxx_figures/xxx_figures_TEMP_OLD_VS_NEW.eps}
...
\begin{figure}[htbp!]
\begin{center}   
     \includegraphics[width=13cm]{./xxx_figures/xxx_figures_TEMP_OLD_VS_NEW_1.eps}
...
\begin{figure}[htbp!]
\begin{center}   
     \includegraphics[width=13cm]{./xxx_figures/xxx_figures_TEMP_COMP_TEMP.eps}
